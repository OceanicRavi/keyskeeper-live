/*
  # Fix Authentication Policies - Final Version
...
DROP POLICY IF EXISTS "Anyone can create maintenance requests" ON maintenance_requests;
DROP POLICY IF EXISTS "Relevant users can update maintenance requests" ON maintenance_requests;
...
-- Add updated_at trigger for viewing requests if function exists
DO $$
BEGIN
